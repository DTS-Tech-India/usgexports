const NewsLatterBox = () => {
  return (
    <div
      className="wow fadeInUp relative z-10 rounded-md bg-primary/[3%] p-8 dark:bg-primary/10 sm:p-11 lg:p-8 xl:p-11 h-screen+"
      data-wow-delay=".2s"
    >
      ...
      Join our newsletter for the latest updates on India&#39;s exports. Get insights, trends, and trade opportunities. Subscribe now!
      </p>
      <form>
        <input
          type="text"

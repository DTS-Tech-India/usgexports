        ...
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
            <div className="w-60 max-w-full px-4 xl:mr-12">
              <Link
                href="/"
                className={`header-logo block w-full ${sticky ? "py-3 lg:py-2" : "py-3"
                  } `}
              >
                <Image
            ...
            <div className="flex w-full items-center justify-between px-4">
              <div>
                ...
                >
                  <ul className="block lg:flex lg:space-x-12 ">
                    ...
                    <Link
                      href="/contact"
                      className="ease-in-up block rounded-md bg-blue-700 py-3 px-8 text-base font-bold text-white transition duration-300 hover:bg-opacity-90 hover:shadow-signUp md:hidden md:px-9 lg:px-6 xl:px-9"
                    >
                      Contact Us
                    </Link>
                  </ul>
              ...
              <div className="flex items-center justify-end pr-16 lg:pr-0">
                <Link
                  href="/contact-us"
                  className="ease-in-up hidden rounded-md bg-blue-700 py-3 px-8 text-base font-bold text-white transition duration-300 hover:bg-opacity-90 hover:shadow-signUp md:block md:px-9 lg:px-6 xl:px-9"
                >
                  Contact Us
                </Link>
                <div>

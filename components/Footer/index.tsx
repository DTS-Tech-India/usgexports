          ...
          <div className="flex flex-wrap justify-evenly">
            <div className="w-full px-4 md:w-1/2 lg:w-3/12 xl:w-3/12">
              <div className="max-w-[360px]">
                ...
                <p className="text-base font-normal leading-relaxed text-slate-500 dark:text-white/90">
          ...
          <div className="container flex flex-col justify-between md:flex-row">
            ...
            <div className="flex items-center justify-center">
              <a
                ...
                className="mx-2 text-[#808080] hover:text-primary"
              >
                <svg
                  width="9"
                  height="18"
            ...
            <p className="text-center text-base text-slate-500 dark:text-white">
              ...
              <a href="https://dtstechindia.com" className="hover:underline">
                DTS Tech India
              </a>
              | Powered by
              <a
                href="https://socialyard.tech"
                className="  hover:underline  hover:transition-all  hover:duration-300 hover:ease-in-out"
              >
                Social Yard
              </a>
            </p>

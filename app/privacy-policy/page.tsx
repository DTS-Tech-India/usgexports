...
export const metadata: Metadata = {
  title: "Privacy Policy | USG Exports",
  description:
  ...
  return (
    <>
      <section className="">
        ...
        <div className="container md:px-10 lg:px-40">
          <p className="my-4">
          ...
          <div className="my-8">
            ...
            <p className="my-4 text-2xl font-semibold">Interpretation</p>
            <p className="my-4">
            ...
            <span className="my-4">
              ...
              <ul className="list-disc px-10">
                ...
                <li>
                  ...
                  &#39;Our&#39; in this Agreement) refers to USG Exports , 23,
                  Joshi Road, Karol Bagh, Delhi - 110002.
                </li>
                <li>
                ...
                <li>
                  <span className="font-semibold">Country</span> refers to: West
                  Bengal, India
                </li>
                <li>
                ...
                <li>
                  ...
                  usgexports.com, accessible from
                  <a
                    href="https://usgexports.com/"
                    className="px-1 font-semibold text-blue-500 hover:text-primary"
                  >
          ...
          <div className="my-8">
            ...
            <ul className="list-disc px-10">
              ...
              <li>
                ...
                To We may share Your information with Our business partners to
          ...
          <div className="my-8">
            ...
            <p className="text-xl font-semibold">Business Transactions</p>
            <p className="my-4">
            ...
            <p className="text-xl font-semibold">Law enforcement</p>
            <p className="my-4">
            ...
            <p className="text-xl font-semibold">Other legal requirements</p>
            <p className="my-4">
          ...
          <div className="my-8">
            ...
            <ul className="list-disc px-10">
              <li>
                By email: <a href="mailto:info@usgexports.com" className="hover:text-primary text-blue-500">info@usgexports.com</a></li>
                <li>
                By visiting this page on our website: <a href=" https://usgexports.com/contact-us" className="font-semisemibold cursor-pointer hover:text-primary text-blue-500">  https://usgexports.com/contact-us</a>


                </li>
                <li>
                By mail: 23, Joshi Road, Karol Bagh, Delhi - 110002
                </li>
            </ul>
          </div>
        </div>

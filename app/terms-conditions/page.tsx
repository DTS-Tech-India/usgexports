  ...
  return (
    <section>
      ...
      <div className="container md:px-40">
        <h1 className="text-3xl">Welcome to usgexports.com!</h1>
        <p className="my-4">
          These terms and conditions outline the rules and regulations for the
          use of USG Exports&#39;s Website, located at{" "}
          <a
            href="https://usgexports.com"
            className="font-semisemibold cursor-pointer hover:text-primary"
          >
            https://usgexports.com
          </a>
          .
        </p>
        <p className="my-4">
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use usgexports.com if you do not agree
        ...
        <div className="my-8">
          ...
          <p className="my-4">
            We employ the use of cookies. By accessing usgexports.com, you
            agreed to use cookies in agreement with the USG Exports&#39; Privacy
            Policy.
          </p>
          <p className="my-4">
        ...
        <div className="my-8">
          ...
          <p className="my-4">
            Unless otherwise stated, USG Exports and/or its licensors own the
            intellectual property rights for all material on usgexports.com. All
            intellectual property rights are reserved. You may access this from
            usgexports.com for your own personal use subjected to restrictions
            set in these terms and conditions.
          </p>
          <span>You must not:</span>
          <ul className="mx-10 list-disc">
            <li>
              Republish material from usgexports.com Sell, rent or sub-license
            </li>
            <li>
              material from usgexports.com Reproduce, duplicate or copy material
            </li>
            <li>
              from usgexports.com Redistribute content from usgexports.com
            </li>
          </ul>
          <p className="my-4">
            Parts of this website offer an opportunity for users to post and
            exchange opinions and information in certain areas of the website.
            USG Exports does not filter, edit, publish or review Comments prior
            to their presence on the website. Comments do not reflect the views
            and opinions of USG Exports,its agents and/or affiliates. Comments
            reflect the views and opinions of the person who post their views
            and opinions. To the extent permitted by applicable laws, USG
            Exports shall not be liable for the Comments or for any liability,
          ...
          <p className="my-4">
            USG Exports reserves the right to monitor all Comments and to remove
            any Comments which can be considered inappropriate, offensive or
            causes breach of these Terms and Conditions.
          </p>
          <span className="my-4">You warrant and represent that:</span>
          <ul className="mx-10 list-disc">
            <li>
            ...
            <li>
              he Comments do not contain any defamatory, libelous, offensive,
          ...
          <p className="my-4">
            You hereby grant USG Exports a non-exclusive license to use,
        ...
        <div className="my-8">
          ...
          <p className="my-4">
            ...
            visibility of the hyperlink compensates the absence of USG Exports;
          ...
          <p className="my-4">
            ...
            sending an e-mail to USG Exports. Please include your name, your
          ...
          <p className="my-4">
            No use of USG Exports&#39;s logo or other artwork will be allowed

...
const AboutPage = () => {
  ...
  return (
            ...
            <div className="w-full px-4 lg:w-1/2">
              <div className="wow fadeInUp max-w-[470px]" data-wow-delay=".2s">
                <div className="mb-6">
                  ...
                  <p className="text-base leading-relaxed text-slate-500 sm:text-md sm:leading-relaxed dark:text-white/90">
    ...
    <section>
<div className="container my-24 mx-auto md:px-6 shadow-lg dark:bg-primary rounded-lg">
  <section className="mb-32 text-center">
    <div className="px-6 py-4  md:px-12 flex flex-col md:flex-row justify-around items-center">
      <h2 className="my-12 text-3xl font-bold tracking-tight text-left">
      Elevate your Culinary Journey with <br />
        <span className=" dark:text-primary-400 text-5xl mt-4">Our Premium Spice Exports!</span>
      </h2>
      <a className="mb-2 h-auto rounded bg-primary dark:bg-white dark:text-black px-12 pt-4 pb-3.5 text-sm font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(59,113,202,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] md:mr-2 md:mb-0"
